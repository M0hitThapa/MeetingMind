...
export const MeetingSummaryPropsSchema = z.object({
...
export const DecisionTrackerPropsSchema = z.object({
...
export const ActionItemListPropsSchema = z.object({
...
export const TopicExplorerPropsSchema = z.object({
...
export const SpeakerAnalyticsPropsSchema = z.object({
...
export const TimelineViewPropsSchema = z.object({
...
export const SentimentTimelinePropsSchema = z.object({
...
export const PriorityMatrixPropsSchema = z.object({
  quadrants: z.object({
...
export const PersonViewPropsSchema = z.object({
  name: z.string(),
...
export const ConflictDetectorPropsSchema = z.object({
...
export const MeetingComparatorPropsSchema = z.object({
...
export const TodoDashboardPropsSchema = z.object({
...
export const RiskPredictorPropsSchema = z.object({
...
export const FlashcardGeneratorPropsSchema = z.object({
...
export const tamboComponents = components;


export function ComponentRegistry() {
  console.log(`[Tambo] ${components.length} components ready for TamboProvider`);
  return null;
}
